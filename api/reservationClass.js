...
router.route('/reservationClass/select').get(function (req, res) {
  //예약현황 select
...
router.route('/reservationClass/insert').post(function (req, res) {
...
router.route('/reservationClass/update').post(function (req, res) {
  // update
...
router.route('/reservationClass/delete').delete(function (req, res) {
  //삭제
